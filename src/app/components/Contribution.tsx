...
export default function Contribution({ id }: ContributionProps) {
  return (
    <section
      id={id}
      className="relative bg-light-yellow/50 flex flex-col items-center gap-3 px-5 sm:px-10 lg:px-20 xl:px-30 2xl:px-50 py-20 md:py-30"
    >
      ...
      <Image
        ...
        className="mt-2 lg:mt-5 xl:mt-6 2xl:mt-7 w-full max-w-md"
      />

      <div className="mt-2 lg:mt-5 xl:mt-6 2xl:mt-7 flex flex-col items-center gap-3 text-justify">
        <p>Your presence at our wedding is the greatest gift of all!</p>
        <p>If you wish to contribute, you can do so via PayPal or via the card box at the venue.</p>
      </div>
